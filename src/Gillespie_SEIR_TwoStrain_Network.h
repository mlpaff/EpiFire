#ifndef GIL_SEIR_TWOSTRAIN_NET_H
#define GIL_SEIR_TWOSTRAIN_NET_H
    ...
    public:
        ...
        typedef enum {
            S, E01, E02, I01, I02, P1, P2, S12, S21, E12, E21, I12, I21, R, cumI1, cumI2, STATE_SIZE // STATE_SIZE must be last
                                    ...
                                    // constructor
        Gillespie_SEIR_TwoStrain_Network ( Network* net, double a1, double a2, double e1, double e2, double g1, double g2, double b1, double b2, double p1, double p2, int intro) {
            network = net;
            alpha1 = a1;
            alpha2 = a2;
            eta1 = e1;
